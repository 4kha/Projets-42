...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/13 16:18:48 by dlaurent          #+#    #+#             */
/*   Updated: 2018/06/28 21:54:51 by dlaurent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Effectue un OR logique entre les deux premiers paramametres et stock le
...
**
** or : Cette opération est un OU bit-à-bit, suivant le même principe que
** and, son opcode est donc évidemment 7.
*/
...
static int	or_is_error(t_a *a, t_p *p, char *ocp)
{
